...
const PLANS: PricingPlan[] = [
  ...
  },
  {
    ...
    features: ['~300 sites/mois', 'Éditeur visuel avancé', 'Export ZIP', 'Support prioritaire', 'Historique illimité'],
    cta: 'Choisir Pro',
  ...
  },
  {
    ...
    features: ['Volume illimité', 'Tout le Pro', 'Support dédié 24/7', 'API access', 'Revente autorisée', 'White label'],
    cta: 'Choisir Agency',
...
const COMPARISON: { category: string; rows: Row[] }[] = [
  {
    category: 'Génération',
    rows: [
      { label: 'Générations/mois',   free: '1',       starter: '~100',      pro: '~300',      agency: 'Illimité' },
      { label: 'Tokens inclus',      free: '8 000',   starter: '800 000',   pro: '2 400 000', agency: '16 000 000' },
      { label: 'Temps de génération',free: '< 30 s',  starter: '< 30 s',    pro: '< 30 s',    agency: '< 30 s' },
      { label: 'Qualités disponibles',free: '1',      starter: '4',         pro: '4',         agency: '4' },
    ],
  },
  {
    category: 'Éditeur',

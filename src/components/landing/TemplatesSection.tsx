...
/* ─────────────────────────────────────────────────────────────────
   PREVIEW COMPONENTS — 12 site types, all CSS-only miniatures
   ───────────────────────────────────────────────────────────────── */
...
function RestaurantGastroPreview() {
  return (
    <div style={{ width: '100%', height: '100%', background: '#050300', fontFamily: 'Georgia,serif', overflow: 'hidden', position: 'relative' }}>
      <div style={{ position: 'absolute', top: '30%', left: '50%', transform: 'translateX(-50%)', width: 120, height: 50, background: 'radial-gradient(ellipse,rgba(212,175,55,0.18) 0%,transparent 70%)', filter: 'blur(18px)' }} />
      ...
      <div style={{ height: 72, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
        ...
        <div style={{ fontSize: 16, fontWeight: 700, color: '#f5f0e8', letterSpacing: 0.5, textAlign: 'center', lineHeight: 1.1 }}>
          L'Excellence<br />
          <span style={{ background: 'linear-gradient(90deg,#b8960c,#d4af37,#f0d060,#d4af37)', backgroundSize: '200% auto', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', animation: 'shimmer-gold 3s linear infinite' }}>à Table</span>
        </div>
    ...
    <div style={{ width: '100%', height: '100%', background: '#03010a', fontFamily: 'system-ui,sans-serif', overflow: 'hidden', position: 'relative' }}>
      ...
      <div style={{ padding: '5px 12px' }}>
        ...
        <div style={{ fontSize: 18, fontWeight: 900, color: '#fff', lineHeight: 1.0, letterSpacing: -1, marginBottom: 6 }}>
          We Build<br />
          <span style={{ background: 'linear-gradient(90deg,#c084fc,#f472b6)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Bold</span> Brands.
        </div>
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: '#f9f8f6', fontFamily: 'system-ui,sans-serif', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '8px 10px', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 3 }}>
        {[
          { bg: '#1a1a2e', h: 42 }, { bg: '#16213e', h: 42 }, { bg: '#0f3460', h: 42 },
...
function EcommerceBijouxPreview() {
  return (
    <div style={{ width: '100%', height: '100%', background: '#fdf8f3', fontFamily: 'Georgia,serif', overflow: 'hidden' }}>
      ...
      <div style={{ height: 20, background: 'linear-gradient(90deg,#b87333,#d4a574,#c8935c,#b87333)', backgroundSize: '200% auto', animation: 'shimmer-gold 4s linear infinite', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ padding: '7px 12px 4px', textAlign: 'center' }}>
        ...
        <div style={{ fontSize: 13, fontWeight: 700, color: '#2d1f14', lineHeight: 1.2, marginBottom: 5 }}>
          L'Art de<br /><span style={{ color: '#b87333' }}>Briller</span>
        </div>
      </div>
      <div style={{ padding: '0 10px', display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 4 }}>
        {[
          { bg: 'linear-gradient(135deg,#f3e4d7,#e8cfc0)', price: '420€', name: 'Bague Or' },
          { bg: 'linear-gradient(135deg,#e8d5c4,#d4b99a)', price: '680€', name: 'Collier' },
          { bg: 'linear-gradient(135deg,#f5ebe0,#dfc9b6)', price: '290€', name: 'Boucles' },
        ].map(p => (
...
function StudioFitnessNeonPreview() {
  return (
    <div style={{ width: '100%', height: '100%', background: '#02050a', fontFamily: 'system-ui,sans-serif', overflow: 'hidden', position: 'relative' }}>
      ...
      <div style={{ padding: '4px 12px 6px' }}>
        ...
        <div style={{ fontSize: 16, fontWeight: 900, color: '#fff', lineHeight: 1.1, marginBottom: 6 }}>
          Forge ton<br /><span style={{ color: '#39ff14' }}>Futur.</span>
        </div>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 3, marginBottom: 5 }}>
        ...
        <div>
          ...
          <div style={{ height: 3, background: '#111', borderRadius: 2, overflow: 'hidden' }}>
            <div style={{ height: '100%', width: '85%', background: 'linear-gradient(90deg,#39ff14,#7fff00)', borderRadius: 2, boxShadow: '0 0 6px rgba(57,255,20,0.8)' }} />
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: '#1a1a18', fontFamily: 'system-ui,sans-serif', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '8px 12px 5px' }}>
        ...
        <div style={{ fontSize: 13, fontWeight: 900, color: '#e8ddd0', lineHeight: 1.2, marginBottom: 5 }}>
          Votre bien<br />idéal <span style={{ color: '#d2b99b' }}>ici.</span>
        </div>
      ...
      <div style={{ padding: '0 10px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 4 }}>
        {[
          { price: '320 000€', type: 'Appt 3P', loc: 'Paris 11e', tag: 'Nouveau', tc: '#d2b99b' },
          { price: '485 000€', type: 'Maison 4P', loc: 'Lyon 6e', tag: 'Coup ♥', tc: '#e11d48' },
        ].map(p => (
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: '#0d0a07', fontFamily: 'Georgia,serif', overflow: 'hidden', position: 'relative' }}>
      ...
      <div style={{ padding: '8px 12px 4px', position: 'relative' }}>
        ...
        <div style={{ fontSize: 14, fontWeight: 900, color: '#f5e6d3', lineHeight: 1.2, marginBottom: 3 }}>
          Le monde<br /><span style={{ color: '#fb923c' }}>t&apos;attend.</span>
        </div>
      ...
      <div style={{ padding: '0 10px', display: 'flex', flexDirection: 'column', gap: 4 }}>
        {[
          { dest: 'Kyoto, Japon', tag: 'Asie', img: 'linear-gradient(135deg,#854d0e,#431407)' },
          { dest: 'Santorini, Grèce', tag: 'Europe', img: 'linear-gradient(135deg,#1e3a5f,#0f2342)' },
        ].map(a => (
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: '#0a0a1a', fontFamily: 'system-ui,sans-serif', overflow: 'hidden', position: 'relative' }}>
      ...
      <div style={{ padding: '8px 12px 4px', position: 'relative' }}>
        ...
        <div style={{ fontSize: 13, fontWeight: 900, color: '#fff', lineHeight: 1.1, marginBottom: 4 }}>
  ...
  return (
    <div style={{ width: '100%', height: '100%', background: '#fefefe', fontFamily: 'Georgia,serif', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '9px 12px 5px', background: 'linear-gradient(180deg,#fdf5f6 0%,#fefefe 100%)' }}>
        ...
        <div style={{ fontSize: 13, fontWeight: 700, color: '#1a0a0d', lineHeight: 1.2, marginBottom: 5 }}>
          Votre défense,<br />notre engagement.
        </div>
...
function EcoleMusiquePreview() {
  return (
    <div style={{ width: '100%', height: '100%', background: '#050305', fontFamily: 'Georgia,serif', overflow: 'hidden', position: 'relative' }}>
      <div style={{ position: 'absolute', top: 22, left: 18, fontSize: 11, color: 'rgba(212,175,55,0.3)', animation: 'float-card 4s ease-in-out infinite' }}>♩</div>
      <div style={{ position: 'absolute', top: 32, right: 22, fontSize: 9, color: 'rgba(212,175,55,0.25)', animation: 'float-card 5s ease-in-out infinite 1s' }}>♪</div>
      <div style={{ position: 'absolute', bottom: 55, left: 12, fontSize: 10, color: 'rgba(212,175,55,0.2)', animation: 'float-card 6s ease-in-out infinite 0.5s' }}>♫</div>
      ...
      <div style={{ padding: '8px 12px 5px', position: 'relative' }}>
        ...
        <div style={{ fontSize: 14, fontWeight: 700, color: '#f5edd0', lineHeight: 1.1, marginBottom: 5 }}>
          L&apos;Art de la<br />
          <span style={{ background: 'linear-gradient(90deg,#b8960c,#d4af37,#f0d060,#d4af37)', backgroundSize: '200% auto', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', animation: 'shimmer-gold 3s linear infinite' }}>Musique</span>
        </div>
      </div>
...
/* ─────────────────────────────────────────────────────────────────
   CAROUSEL DATA — 2 rows × 6 items = 12 total
   ───────────────────────────────────────────────────────────────── */
...
const ROW1: CarouselItem[] = [
  {
    key: 'restaurant-gastro',
    label: 'Restaurant Gastronomique',
    category: 'Restaurant',
    prompt: 'Crée un site restaurant gastronomique élégant, fond noir avec accents dorés, police serif, avec menu, galerie et réservation en ligne',
    Preview: RestaurantGastroPreview,
  },
  {
    key: 'startup-tech',
    label: 'Startup Tech IA',
    category: 'Tech',
    prompt: 'Crée un site startup tech IA, fond très sombre #020409, accents cyan #38bdf8, grille animée en arrière-plan, hero futuriste avec stats et CTA',
    Preview: StartupTechPreview,
  },
  {
    key: 'agence-creative',
    label: 'Agence Créative',
    category: 'Créatif',
    prompt: 'Crée un site agence créative bold, fond très sombre, dégradé violet/rose, typographie massive, showcase de projets et formulaire de contact',
    Preview: AgenceCreativePreview,
  },
  {
    key: 'portfolio-photo',
    label: 'Portfolio Photographe',
    category: 'Portfolio',
    prompt: 'Crée un portfolio photographe minimaliste, fond blanc cassé, typographie épurée, grande galerie pleine page, section about et contact',
    Preview: PortfolioPhotoPreview,
  },
  {
    key: 'ecommerce-bijoux',
    label: 'E-commerce Bijoux',
    category: 'E-commerce',
    prompt: 'Crée un site e-commerce de bijoux luxueux, fond crème/beige, accents or rose, ambiance haute joaillerie, grille produits et lookbook',
    Preview: EcommerceBijouxPreview,
  },
  {
    key: 'cabinet-medical',
    label: 'Cabinet Médical',
    category: 'Santé',
    prompt: 'Crée un site cabinet médical professionnel, fond blanc, accents bleu médical, prise de rendez-vous en ligne, liste des spécialités et équipe',
    Preview: CabinetMedicalPreview,
  },
]
...
const ROW2: CarouselItem[] = [
  {
    ...
    category: 'Fitness',
    prompt: 'Crée un site studio fitness énergique, fond noir, accents vert néon, compteurs animés, planning des cours et offres d\'abonnement',
    Preview: StudioFitnessNeonPreview,
  },
  {
    key: 'immo',
    label: 'Agence Immobilière',
    category: 'Immobilier',
    prompt: 'Crée un site agence immobilière moderne, fond gris foncé presque noir, accents beige doré, barre de recherche, grille de biens et estimateur',
    Preview: AgenceImmoPreview,
  },
  {
    key: 'blog-voyages',
    label: 'Blog Voyages',
    category: 'Blog',
    prompt: 'Crée un blog voyages inspirant, fond sombre marron, accents orange coucher de soleil, articles mis en avant, destinations en grille et newsletter',
    Preview: BlogVoyagesPreview,
  },
  {
    key: 'saas-dashboard',
    label: 'SaaS Dashboard',
    category: 'SaaS',
    prompt: 'Crée un site SaaS sombre #0a0a1a, accents violet, interface data moderne, hero avec stats animées, features, pricing et témoignages',
    Preview: SaasDashboardPreview,
  },
  {
    key: 'avocat',
    label: 'Cabinet Juridique',
    category: 'Juridique',
    prompt: 'Crée un site cabinet d\'avocats sobre et professionnel, fond blanc, accents bordeaux, domaines d\'expertise, équipe et formulaire de contact',
    Preview: AvocatPreview,
  },
  {
    key: 'ecole-musique',
    label: 'École de Musique',
    category: 'Musique',
    prompt: 'Crée un site école de musique élégant, fond noir, accents or, notes musicales flottantes en CSS, liste d\'instruments, planning des cours et inscription',
    Preview: EcoleMusiquePreview,
  },
]
...
function CarouselModal({ item, onClose, onSelect }: { item: CarouselItem; onClose: () => void; onSelect: (prompt: string) => void }) {
  ...
  const scaledH = Math.round(215 * scale)
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div
        ...
        style={{ background: 'rgba(2,2,15,0.85)' }}
        onClick={onClose}
      />
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-3 right-3 z-20 w-8 h-8 flex items-center justify-center text-white/40 hover:text-white transition-colors rounded-lg hover:bg-white/10"
          aria-label="Fermer"
        >
        ...
        <div
          ref={containerRef}
          style={{ width: '100%', overflow: 'hidden', height: scaledH, background: '#050510' }}
        >
        ...
        {/* Footer */}
        <div style={{ padding: '18px 24px', borderTop: '1px solid rgba(124,58,237,0.15)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12, flexWrap: 'wrap' }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
              <h3 style={{ fontSize: 16, fontWeight: 800, color: '#e2e8f0', margin: 0 }}>{item.label}</h3>
              <span style={{ fontSize: 11, fontWeight: 600, padding: '2px 8px', borderRadius: 20, background: 'rgba(124,58,237,0.2)', color: '#c4b5fd', border: '1px solid rgba(124,58,237,0.3)' }}>
                {item.category}
              </span>
            </div>
            <p style={{ fontSize: 12, color: '#64748b', margin: 0, lineHeight: 1.5 }}>
              Généré par Claude AI en moins de 30 secondes
            </p>
          </div>
          <button
            ...
            onMouseEnter={e => (e.currentTarget.style.boxShadow = '0 4px 30px rgba(109,40,217,0.65)')}
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'linear-gradient(0deg,rgba(4,4,15,0.96) 0%,rgba(4,4,15,0.6) 60%,transparent 100%)',
...
function TemplateCarousel({ onSelect }: { onSelect: (prompt: string) => void }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ overflow: 'hidden', position: 'relative', marginBottom: 16 }}>
        ...
        <div className="carousel-track" style={{ animationPlayState: playState }}>
          {row1Doubled.map((item, i) => (
            <CarouselCard key={`r1-${item.key}-${i}`} item={item} onClick={setModal} />
          ))}
        </div>
      </div>
      ...
      <div style={{ overflow: 'hidden', position: 'relative' }}>
        <div style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: 100, background: 'linear-gradient(90deg,#04040f,transparent)', zIndex: 10, pointerEvents: 'none' }} />
        <div style={{ position: 'absolute', right: 0, top: 0, bottom: 0, width: 100, background: 'linear-gradient(-90deg,#04040f,transparent)', zIndex: 10, pointerEvents: 'none' }} />
        <div className="carousel-track-reverse" style={{ animationPlayState: playState }}>
          {row2Doubled.map((item, i) => (
            <CarouselCard key={`r2-${item.key}-${i}`} item={item} onClick={setModal} />
          ))}
        </div>
      </div>
...
export default function TemplatesSection({ onSelect }: Props) {
  return (
    <section id="templates" className="py-24 overflow-hidden" style={{ background: '#04040f' }}>
      <motion.div
      ...
      >
        <p className="text-sm font-semibold uppercase tracking-widest mb-3" style={{ color: '#7c3aed' }}>Templates</p>
        <h2 className="text-4xl md:text-5xl font-black mb-4" style={{ color: '#e2e8f0' }}>
      ...
      <motion.p
        ...
        className="text-center mt-8 text-sm px-6"
        style={{ color: '#334155' }}
      >
        Cliquez sur une carte pour l&apos;agrandir et créer un site similaire
      </motion.p>
    </section>
  )
}
